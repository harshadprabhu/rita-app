...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: theme.colors.surface, borderRadius: theme.radius.md, padding: theme.spacing.md, marginBottom: theme.spacing.md, borderLeftWidth: 3, borderLeftColor: theme.priorityColors.critical },
  ...
  breachBadge: { fontSize: 10, fontWeight: '700', color: theme.priorityColors.critical },
  ...
  reassignBtn: { alignSelf: 'flex-start', backgroundColor: theme.colors.surface2, borderRadius: theme.radius.sm, paddingHorizontal: theme.spacing.md, paddingVertical: theme.spacing.xs },
