...
const CATEGORY_RULES: { key: string; markers: string[] }[] = [
  ...
  { key: 'Facility/Maintanace', markers: ['washroom', 'light', 'fixture', 'nvr', 'cctv', 'air conditioner', 'music system', 'moosic', 'water', 'electrical'] },
  { key: 'Hardware Issue', markers: ['printer', 'scanner', 'laptop', 'desktop', 'tablet', 'keyboard', 'mouse', 'monitor', 'ink', 'cartridge', 'hardware', 'barcode', 'certificate', 'driver'] },
  { key: 'POS Issue', markers: ['pos', 'coupon', 'scheme', 'discount', 'coin', 'bonus', 'tender', 'mto', 'set break', 'gold rate', 'making charge', 'movement', 'billing'] },
