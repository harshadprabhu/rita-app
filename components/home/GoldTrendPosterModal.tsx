...
// live here rather than in a sibling stub: a .native file importing a runtime
// value from its own path resolves to itself and comes back undefined.
          ...
          <View style={styles.actions}>
            <TouchableOpacity style={[styles.btn, styles.shareBtn]} onPress={share} disabled={sharing} activeOpacity={0.85}>
              {sharing ? <ActivityIndicator color={theme.colors.textPrimary} /> : (
                <>
                  <Ionicons name={isWeb ? 'download-outline' : 'share-social-outline'} size={18} color={theme.colors.textPrimary} />
