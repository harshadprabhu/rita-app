...
export default function AdminLayout() {
  ...
  return (
    ...
    >
      ...
      <Tabs.Screen name="sla-console" options={{ title: t('tabs.sla'), tabBarIcon: ({ color, size }) => <Ionicons name="alert-circle-outline" size={size} color={color} /> }} />
      <Tabs.Screen
        name="notifications"
        options={{
          title: t('tabs.alerts'),
      ...
      <Tabs.Screen name="feedback-analytics" options={{ href: null }} />
