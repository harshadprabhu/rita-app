...
const styles = StyleSheet.create({
  ...
  searchBox: {
    ...
    borderRadius: 14, paddingHorizontal: theme.spacing.md, height: 48, ...theme.shadows.xs,
  },
  searchInput: { flex: 1, color: theme.colors.textPrimary, fontSize: 15, paddingVertical: 0 },
  chipRow: { gap: 8, paddingRight: theme.spacing.lg },
  compactFilterBar: {
    flexDirection: 'row', alignItems: 'center', gap: 8,
    paddingHorizontal: theme.spacing.lg, paddingVertical: theme.spacing.md,
  },
  compactChip: {
    paddingHorizontal: 16, height: 36, justifyContent: 'center' as const,
  ...
  compactChipText: { fontSize: 13, fontWeight: '700', color: theme.colors.textSecondary },
  compactChipTextActive: { color: '#fff' },
  pill: {
    borderWidth: 1, borderColor: theme.colors.border, backgroundColor: theme.colors.surface,
    borderRadius: 18, paddingHorizontal: 16, height: 36, justifyContent: 'center' as const,
  },
  pillActive: {
    backgroundColor: theme.colors.brand, borderColor: theme.colors.brand,
  },
  ...
  exportText: { fontSize: 12, fontWeight: '800', color: theme.colors.brand },
});
